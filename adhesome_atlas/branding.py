...
def identity_banner():
    ...
    st.markdown('''<style>
    .atlas-identity{display:flex;align-items:center;gap:24px;background:#fff;border:1px solid #dce6ed;border-radius:18px;padding:16px 24px;margin-bottom:16px;color:#18354a;box-shadow:0 4px 18px #13314806}
